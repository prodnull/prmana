...
prmana provides OIDC-based authentication for SSH login on Linux/Unix systems. The system consists of:
...
| Event types | Login success/fail, replay | ✅ Unit tests |
...
| Remote Services: SSH | T1021.004 | OIDC MFA enforcement |
