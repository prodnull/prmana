...
| **OAuth practitioner, new to prmana** | Section 6 (Architecture) | Sections 6-9 map concepts to code |
| **Security auditor** | Section 10 (Security Analysis) | Sections 10-12 cover threat model and invariants |
...
1. [The Problem: Why Identity on Unix Is Broken](#1-the-problem-why-identity-on-unix-is-broken)
2. [OAuth 2.0: Delegated Authorization](#2-oauth-20-delegated-authorization)
3. [OpenID Connect: The Identity Layer](#3-openid-connect-the-identity-layer)
4. [JWTs: The Currency of Trust](#4-jwts-the-currency-of-trust)
5. [JWKS: Distributing Trust at Scale](#5-jwks-distributing-trust-at-scale)
6. [prmana Architecture](#6-prmana-architecture)
7. [DPoP: Proof of Possession](#7-dpop-proof-of-possession)
8. [The Authentication Flows](#8-the-authentication-flows)
9. [Hardware-Bound Identity](#9-hardware-bound-identity)
10. [Security Deep Dive](#10-security-deep-dive)
11. [The Full Authentication Flow, Step by Step](#11-the-full-authentication-flow-step-by-step)
12. [Provider-Specific Behavior: Lessons from Live Testing](#12-provider-specific-behavior-lessons-from-live-testing)

---

## 1. The Problem: Why Identity on Unix Is Broken
...
Each of these flows is covered in detail in [Section 8](#8-the-authentication-flows).
...
## 5. JWKS: Distributing Trust at Scale
...
## 11. The Full Authentication Flow, Step by Step
...
## 12. Provider-Specific Behavior: Lessons from Live Testing
